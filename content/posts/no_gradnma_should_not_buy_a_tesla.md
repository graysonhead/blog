+++
title = "No, Grandma Shouldn't Buy A Tesla"
date = 2026-08-04
[taxonomies]
	tags = [ "Human Factors", "Accidents", "Autonomy", "Opinion" ]
+++
...
The complaints continued to flood in, and in the minds of the public, the drivers and floor mats were not to blame: it was the newfangled ETC system. It was (and in some cases still is) the opinion of many that a fault in the ETC could cause the car to accelerate out of control, and this was the cause of these crashes. In 2011, NASA and the NHTSA published a [report](https://www.nhtsa.gov/sites/nhtsa.gov/files/nhtsa-ua_report.pdf) stating unequivocally that floor mats and pedal misapplication were to blame for the overwhelming majority of SUAs.
...
Recently, a 76-year-old woman was [killed](https://www.nbcdfw.com/news/national-international/tesla-crashes-into-texas-home-killing-76-year-old-woman/4039500/) when a Tesla driven by a 44-year-old man flew into her daughter's home after abruptly accelerating to near highway speeds on a residential street.
...
Aviation researchers have been documenting this since the introduction of glass cockpit aircraft in the 1980s. Earl Wiener, studying advanced automation in commercial transport for NASA, described the phenomenon of automation that solves one set of problems while quietly creating new ones.[^10]
...
On the night of June 1, 2009, Air France Flight 447 stalled into the Atlantic Ocean and killed all 228 people aboard. When the pitot tubes iced over and the autopilot disconnected, the aircraft transitioned into a reversionary control law that lacked the stall protections the crew had expected to be there.[^9] Operating under extreme cognitive load, in the middle of the night, over open ocean, the pilot flying pulled back on the sidestick - exacerbating the stall. Had he understood the logic of the reversionary control law, perhaps he wouldn't have.
...
Mode confusion has been cited in several accidents, most notably in a fatal Tesla accident report that occurred on May 7, 2016, in Florida[^tesla-fl]. In many cases, the NHTSA found that drivers remained confused about the systems even after reading the manual, and then went on to note that a large percentage of drivers fail to read the manual anyways.
...
<img src="../../images/automation_danger/737-yoke.jpg" alt="Yoke from a 737 jet" style="max-width: 50%; display: block; margin: 0 auto;">
...
<img src="../../images/automation_danger/f150-steering-wheel.jpg" alt="Steering wheel from a 2021 Ford truck" style="max-width: 50%; display: block; margin: 0 auto;">
...
In case any automotive engineers are reading this: Please, for the love of god, get together with your industry peers and decide on a standard button iconography and color for a "disable all ADAS features" button[^7], and make sure every single car produced from now on has this standardized button. The best fix for mode confusion is to revert the entire system to a known state. Usually the state where the driver is driving the car, and the computer isn't.
...
The Swedish public was not interested in fixing this problem. A non-binding referendum put forth regarding a switch to right-hand driving on 16 October 1955 was met with an emphatic populace: 82.9% against.[^12] The static objections were predictable, mostly money-related, but underneath it all was the ordinary human preference for familiarity.
...
<img src="../../images/automation_danger/caps.jpg" alt="Caps deployment on an SR20 during flight testing" style="max-width: 50%; display: block; margin: 0 auto;">
...
This is just as true of aircraft, but for aircraft, we have training. We have operating handbooks that most pilots actually read and study. We have flight reviews, ratings, checkrides, and a safety culture that permeates everything from flight schools to flying clubs. There is no equivalent of this for ADAS. No training requirement, no proficiency program, no demonstrated understanding of the system's limitations before you can press the button to engage it (and good luck remembering how to disengage it). The technology is considerably more complex than a parachute handle or autopilot level button, and considerably more invisible in its operation. Which means the behavioral compensation it induces is just as real, but the actual benefit it provides is smaller by comparison.

This isn't to say safety engineering is hopeless. Driving is meaningfully safer than it was thirty years ago: fatality rates per 100 million vehicle miles traveled fell from 1.73 in 1994 to 1.19 in 2024.[^6] But the gains that actually stuck came from seatbelts, airbags, crumple zones, median barriers, and better road design: systems that work without asking for your cooperation, that you cannot perceive and therefore cannot offset. The moment a safety system becomes visible enough to change how you feel about risk, you have introduced the compensating mechanism. ADAS is nothing if not visible.
...
[^2]: [DOJ: Justice Department Announces Criminal Charge Against Toyota Motor Corporation](https://www.justice.gov/archives/opa/pr/justice-department-announces-criminal-charge-against-toyota-motor-corporation-and-deferred)

[^3]: Bloomberg analysis of NHTSA data; Consumer Reports analysis of 2008 MY NHTSA complaints; NHTSA/NASA Technical Report (2011)

[^4]: [FMVSS 135](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-V/part-571/subpart-B/section-571.135)

[^8]: [Mercedes-Benz: 25 Years of the Brake Assist System (BAS)](https://www.mercedes-fans.de/magazin/classic/vor-25-jahren-mercedes-benz-bremsassistent-bas-wird-vorgestellt-voller-bremsdruck.18230)

[^10]: [Wiener, "Human Factors of Advanced Technology ('Glass Cockpit') Transport Aircraft" (NASA Contractor Report 177528, 1989)](https://ntrs.nasa.gov/api/citations/19890016609/downloads/19890016609.pdf)

[^11]: [Sarter & Woods, "How in the World Did We Get Into That Mode? Mode Error and Awareness in Supervisory Control" (Human Factors, 1995)](https://doi.org/10.1518/001872095779049516)

[^9]: [BEA Final Report on the accident on June 1, 2009, to the Airbus A330-203 registered F-GZCP, Air France flight 447](https://bea.aero/fileadmin/documents/docspa/2009/f-cp090601.en/pdf/f-cp090601.en.pdf)

[^tesla-fl]: [NHTSA report on the May 7, 2016, fatal Tesla Autopilot crash in Florida](https://static.nhtsa.gov/odi/inv/2016/INCLA-PE16007-7876.PDF)
...
[^12]: [1955 Swedish driving side referendum](https://en.wikipedia.org/wiki/1955_Swedish_driving_side_referendum)

[^13]: [Dagen H](https://en.wikipedia.org/wiki/Dagen_H)

[^16]: [Wilde, "The Theory of Risk Homeostasis" (Risk Analysis, 1982)](https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1539-6924.1982.tb01384.x)

[^14]: [Federal Motor Vehicle Safety Standards; Electronic Stability Control Systems](https://www.federalregister.gov/documents/2007/04/06/07-1649/federal-motor-vehicle-safety-standards-electronic-stability-control-systems-controls-and-displays) (ESC, which requires ABS hardware, was phased in for all light vehicles from 2008 through September 2011)

[^15]: [Aschenbrenner & Biehl, "Improved Safety Through Improved Technical Measures? Empirical Studies Regarding Risk Compensation with Anti-Lock Braking Systems" (1994)](https://trid.trb.org/view/457353)

[^17]: [Cirrus Airframe Parachute System and Odds of a Fatal Accident in Cirrus Aircraft Crashes (NTSB data study)](https://www.researchgate.net/publication/317289231_Cirrus_Airframe_Parachute_System_and_Odds_of_a_Fatal_Accident_in_Cirrus_Aircraft_Crashes)

[^18]: [Aviation Consumer: Cirrus Safety Record Just Average](https://aviationconsumer.com/industry-news/cirrus-examined-just-average-for-safety/)

[^19]: [AOPA: How Cirrus Radically Reduced Fatal Accidents](https://www.aopa.org/news-and-media/all-news/2016/july/24/how-cirrus-reduced-accidents)

[^5]: Ironically, aircraft autopilots do require continuous attention and monitoring, but that isn't what the general public tends to believe.

[^6]: [NHTSA Fatality Analysis Reporting System, Trends in Fatality Rates per 100M VMT](https://www-fars.nhtsa.dot.gov/Trends/TrendsGeneral.aspx)
